...
namespace images {
	...
	inline ID3D11ShaderResourceView * fivem = nullptr;
	inline ID3D11ShaderResourceView* qh = nullptr;
...
namespace colors {
	...
	const ImVec4 SecondColor = { 0.863f, 0.078f, 0.235f, .8f };        // Crimson base
	...
	const ImVec4 Red = { 0.863f, 0.078f, 0.235f, 1.0f };              // Crimson red
	const ImVec4 Orange = { 0.863f, 0.078f, 0.235f, 1.0f };           // Also crimson
}